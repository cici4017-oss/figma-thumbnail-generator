...
const PRODUCT_ROWS = {
  simpleMeal: [
    ...
    { code: 'SIMPLE_BEEF_QUAIL_JANGJORIM_150', brand: '본죽', name: '본 메추리알쇠고기장조림', capacity: '150g' },
    { code: 'SIMPLE_BEEF_JANGJORIM_300', brand: '본죽', name: '본 쇠고기장조림', capacity: '300g' },
    { code: 'SIMPLE_MINI_BEEF_JANGJORIM_70', brand: '본죽', name: '미니 쇠고기장조림', capacity: '70g' },
    { code: 'SIMPLE_MINI_BUTTER_BEEF_JANGJORIM_70', brand: '본죽', name: '미니 본버터쇠고기장조림', capacity: '70g' },
    { code: 'SIMPLE_MINI_BUTTER_POTATO_JANGJORIM_75', brand: '본죽', name: '미니 본버터감자장조림', capacity: '75g' },
    { code: 'SIMPLE_QUAIL_JANGJORIM_1000', brand: '본죽', name: '메추리알장조림 대용량 1kg', capacity: '1kg' },
    { code: 'SIMPLE_QUAIL_JANGJORIM_600', brand: '본죽', name: '메추리알장조림 대용량 600g', capacity: '600g' },
    { code: 'SIMPLE_CHUEOTANG_700', brand: '본죽', name: '느리게만든 본남도식추어탕', capacity: '700g' },
    { code: 'SIMPLE_GALBIJJIM_700', brand: '본죽', name: '느리게만든 갈비찜', capacity: '700g' },
    { code: 'SIMPLE_DOGANITANG_700', brand: '본죽', name: '느리게만든 본도가니탕', capacity: '700g' },
    { code: 'SIMPLE_YUKGAEJANG_640', brand: '본죽', name: '느리게만든 본대파육개장', capacity: '640g' },
    { code: 'SIMPLE_HEALTHY_ABALONE_SAMGYE_JUK_330', brand: '본죽', name: '헬시 전복삼계죽', capacity: '330g' },
    { code: 'SIMPLE_HEALTHY_BEEF_ROOT_VEG_JUK_330', brand: '본죽', name: '헬시 쇠고기뿌리야채죽', capacity: '330g' },
    { code: 'SIMPLE_HANWOO_SEOLLEONGTANG_450', brand: '본죽', name: '본설렁탕 한우설렁탕', capacity: '450g' },
    { code: 'SIMPLE_YANGJI_SUYUK_100', brand: '본죽', name: '본설렁탕 양지수육', capacity: '100g' },
    { code: 'SIMPLE_SIGNATURE_ABALONE_JUK_200', brand: '본죽', name: '시그니처 전복죽', capacity: '200g' },
    { code: 'SIMPLE_SIGNATURE_PUMPKIN_JUK_200', brand: '본죽', name: '시그니처 단호박죽', capacity: '200g' },
    { code: 'SIMPLE_SIGNATURE_BEEF_JUK_200', brand: '본죽', name: '시그니처 쇠고기죽', capacity: '200g' },
    { code: 'SIMPLE_SIGNATURE_SPICY_OCTOPUS_KIMCHI_JUK_200', brand: '본죽', name: '시그니처 얼큰낙지김치죽', capacity: '200g' },
    { code: 'SIMPLE_SIGNATURE_SWEET_BLACK_BEAN_80', brand: '본죽', name: '시그니처 달콤검은콩자반', capacity: '80g' },
    { code: 'SIMPLE_SIGNATURE_SPICY_PERILLA_LEAF_80', brand: '본죽', name: '시그니처 매콤깻잎무침', capacity: '80g' },
    { code: 'SIMPLE_SIGNATURE_CRISPY_LOTUS_ROOT_80', brand: '본죽', name: '시그니처 아삭연근조림', capacity: '80g' },
    { code: 'SIMPLE_SIGNATURE_SHREDDED_SQUID_60', brand: '본죽', name: '시그니처 촉촉진미채볶음', capacity: '60g' },
  ],
  baby: [
    ...
    { code: 'BABY_KIDS_MIXED_VEGETABLE_JUK_170', brand: '본죽', name: '본죽키즈 모둠야채죽', capacity: '170g' },
    { code: 'BABY_KIDS_NUTRITION_CHICKEN_JUK_170', brand: '본죽', name: '본죽키즈 영양닭죽', capacity: '170g' },
    { code: 'BABY_KIDS_ABALONE_JUK_170', brand: '본죽', name: '본죽키즈 튼튼전복죽', capacity: '170g' },
    { code: 'BABY_KIDS_HANWOO_VEGETABLE_JUK_170', brand: '본죽', name: '본죽키즈 한우야채죽', capacity: '170g' },
    { code: 'BABY_ORGANIC_RICE_PUFF_RED_30', brand: '베이비본죽', name: '유기농쌀과자퍼프 레드', capacity: '30g' },
    { code: 'BABY_ORGANIC_RICE_PUFF_YELLOW_30', brand: '베이비본죽', name: '유기농쌀과자퍼프 옐로우', capacity: '30g' },
    { code: 'BABY_ORGANIC_RICE_PUFF_PURPLE_30', brand: '베이비본죽', name: '유기농쌀과자퍼프 퍼플', capacity: '30g' },
  ],
};
